...
urlpatterns = [
    ...
    re_path(r'^logcfo$', main_views.cfopage, name='cfopage'),
    re_path(r'^logaccountant$', main_views.accountantpage, name='accountantpage'),
    re_path(r'^logvendor$', main_views.vendorpage, name='vendorpage'),
    re_path(r'^logmanager$', main_views.managerpage, name='managerpage'),
    re_path(r'^login/$',
    ...
    re_path(r'^subPayment$', main_views.submitPaymentPage, name='submitPaymentPage'),
